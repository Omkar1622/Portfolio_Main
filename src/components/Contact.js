...
function Contact({resumeData}) {
  ...
  return (
    <Container className='contact'>
        ...
        <MailButton data-aos="fade-in"><a href="mailto:omkarkhatale1002@gmail.com">Say Hello</a></MailButton>
        ...
        {links?
            <Links >
                ...
                <Link url="mailto:omkarkhatale1002@gmail.com" icon={<IoMailOpen size={22}/>}/>
            </Links>
            :
            <></>
        }   
        ...
        <Bottom>Designed & Built by <span>Omkar Khatale</span></Bottom>
