...
function Header() {
    ...
    return (
        <MainContainer isOpen={open} scrollDirection={scrollDirection} scrolledToTop={scrolledToTop}>
            <HeadContainer>
            <Logo isOpen={open}>Omkar Khatale</Logo>
            ...
            <Container id='navbar' isOpen={open}>
                ...
                <Resume>
                    <a href="https://drive.google.com/file/d/1ESrTeD1_Lq9RpQafPS03nHIeloEM6x7A/view?usp=sharing" target="_blank">Resume</a>
                </Resume>
